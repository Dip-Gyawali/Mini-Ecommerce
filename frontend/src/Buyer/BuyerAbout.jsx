    ...
    <div className="flex items-center justify-center h-[90vh]">
      <div className="flex flex-col md:flex-row-reverse items-center justify-between w-full max-w-6xl p-8">
        ...
        <div className="flex-1 text-left p-4 md:p-8">
          <h2 className="text-4xl font-bold text-gray-800">About Our Store</h2>
          <p className="mt-4 text-lg text-gray-600 leading-relaxed">
            Our store is dedicated to providing the latest technology and
            gadgets to our customers. From mobile phones to laptops, we offer a
            wide range of products that meet your needs and budget. Our mission
            is to bring you the best quality at competitive prices, with a focus
            on customer satisfaction and service.
          </p>
          <p className="mt-4 text-lg text-gray-600 leading-relaxed">
            Established in 2024, we have been at the forefront of technological
            innovation, ensuring that our customers have access to the latest
            trends and advancements. We pride ourselves on our commitment to
            quality and our dedication to serving you.
          </p>
